...
<nav class="navbar navbar-b navbar-trans navbar-expand-md fixed-top" id="mainNav">
    <div class="container">
      ...
      <div class="navbar-collapse collapse justify-content-end" id="navbarDefault">
        <ul class="navbar-nav">
          <li class="nav-item">
            <a class="nav-link js-scroll active" href="/postss">{{$title}}</a>
          </li>
  ...
  @endif
                    ...
                    @if($next)
                  <a href="{{route('post.show' , ['slug'=> $next->slug])}}" class="badge badge-primary">{{$next->title}}</a>
                  @endif

                  @if($prev)

                  <a href= "{{route('post.show' , ['slug'=> $prev->slug])}}" class="badge badge-secondary">{{$prev->title}}</a>
