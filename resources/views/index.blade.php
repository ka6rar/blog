...
@yield('content')
                ...
                <nav class="navbar navbar-b navbar-trans navbar-expand-md fixed-top" id="mainNav">
                  <div class="container">
                    ...
                    <div class="navbar-collapse collapse justify-content-end" id="navbarDefault">
                      <ul class="navbar-nav">
                        <li class="nav-item">
                          <a class="nav-link js-scroll active" href="/postss">d</a>
                        </li>
                        @foreach ($posts as $catfre)

                        <li class="nav-item">
                          <a class="nav-link js-scroll" href="">{{$catfre->name}}</a>
                        </li>
                        @endforeach
                ...
                @endif
                  ...
                  <form  method="GET" action="/resuits" class="form-inline my-2 my-lg-0">
                    {{ csrf_field() }}
                ...
                <section id="work" class="portfolio-mf sect-pt4 route">
                  <div class="container">
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-4">
                        <div class="work-box">
                        <a href="{{ route('post.show' , ['slug' => $post->slug]) }}" data-lightbox="gallery-mf">
                            <div class="work-img">
                            <img  style="width:100px;" src="{{$post->featrued}}" alt="" class="img-fluid" >
                            </div>
                            <div class="work-content">
                              <div class="row">
                                ...
                                <h2 class="w-title">{{$post->title}}</h2>
                                  <div class="w-more">
                                  <span class="w-ctegory">Web Design</span> / <span class="w-date">{{$post->created_at->diffForHumans()}}</span>
                                  </div>
                                </div>
                                <div class="col-sm-4">
                                  <div class="w-like">
